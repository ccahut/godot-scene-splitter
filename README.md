...
- Automatically creates folders based on object name prefixes (for example prop_table goes to models/prop/)
...
2. Copy the addons/scene_splitter folder into your projects addons directory
